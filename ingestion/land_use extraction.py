...
lookup_dic = {  #-1 to the value in the lookup table
    "0002": [7, 31],
    "0003": [99, 100, 101, 129],    #total population
    "0004": [7, 8, 10],
...
lookup_dic2 = {  #-1 to the value in the lookup table
    "0002": ["male_tot", "fmale_tot"],
    "0003": ["med_age", "med_age_m", "med_age_f", "pop_tot"],    #total population
...
for key in lookup_dic2.keys():
    ...
    df_val[key] = pd.DataFrame(columns=cols, dtype=np.int8)  # from here
    print(df_val[key].columns)
print(df_val)
